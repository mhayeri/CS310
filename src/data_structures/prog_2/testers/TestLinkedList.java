...
public class TestLinkedList {
    ...
    static LinearList<Integer> llist = null;

    /**
     * @param args The main method. In this case, we don't accept any arguments. We
     *             create a new linked list object and fill it with Integers.
     */
    public static void main(String[] args) {
        ...
        try {
            ...
            if (llist.size() != n) {
                System.err.println("We added " + n + " elements to the start of the list, but the size reported was "
                        + llist.size());
                error = true;
            }
            ...
            if (llist.removeFirst() != null) {
                System.err
                        .println("The list should be empty and not be able to remove anything and should return null");
                error = true;
            }
