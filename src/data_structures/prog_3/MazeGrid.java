...
public class MazeGrid extends JFrame {
    ...
    private void setLookAndFeel() {
        try {
            ...
            JOptionPane.showMessageDialog(this, "Required Metal Look and Feel resources unavailable.  "
    ...
    // may be valid if the cell is within the grid, and does not have a black
    // background.
    // However, such moves are illegal. This method does **NOT** detect illegal
    // moves,
    // only invalid ones.
    ...
    // Sets the background color of the cell to indicate that it is in the shortest
    // path.
    ...
    // Sets the distance in the given GridCell instance, and displays that distance
    // on the grid.
